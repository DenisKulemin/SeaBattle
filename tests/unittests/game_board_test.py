...
def test_set_ship_coordinate():
    ...
    with pytest.raises(BlockedAreaError):
        board_game.set_ship_coordinate([(1, 2), (1, 3)])
    ...
    # Check if method raise TypeError if used wrong coordinate format.
...
def test_shoot():
    ...
    # Check if method raise ShotCellEarlierError if cell was shot earlier.
